...
public abstract class Weapon : NetworkBehaviour
{
    ...
    protected PlayerCombat _currentHolder;
    ...
    public int Durability
    {
        get
        {
            return _durablity.Value;
        }
        private set
        {
            _durablity.Value = Mathf.Clamp(value, 0, _weaponSO.durability);
        }
    }

    NetworkVariable<int> _durablity = new NetworkVariable<int>();

...
{
    [Tooltip("Material to switch to to indicate this item being highlighted")]
    [SerializeField] Material _highlightMaterial;
    [Tooltip("The parent holding the model. This is used to get all the renderers to switch materials")]

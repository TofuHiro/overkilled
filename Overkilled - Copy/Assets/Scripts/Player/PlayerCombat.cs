...
public class PlayerCombat : MonoBehaviour
{
    ...
    {
        AttackType attackType = _currentWeapon.GetWeaponInfo().attackType;
        OnAttack?.Invoke(attackType);
    }

    void Weapon_OnSecondaryAttack()
    {
        AttackType attackType = _currentWeapon.GetWeaponInfo().secondaryAttackType;
        OnSecondaryAttack?.Invoke(attackType);
    }

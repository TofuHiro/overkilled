...
public class EnemyController : NetworkBehaviour
{
    ...
    [Tooltip("The dot prod threshold where the enemy will perform an attack. E.g. If set to 1.0f, a dot prod of 1.0f will be required (enemy must look directly at player) to perform attacks")]
    [SerializeField] float _attackAccuracy = 0.9f;
